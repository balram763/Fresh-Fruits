...
//   // const payment = cardItems?.reduce((p,c)=> p+c.price)
//   // console.log(payment)
//   const totalCartValue = cardItems.reduce((sum, item) => sum + item.price * item.quantity, 0);
...
//     <div id='total'>{totalCartValue}</div>
//     </div>
